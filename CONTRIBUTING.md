# Contributing to `arizona_example`
...
`arizona_example` is licensed under the [Apache License Version 2.0](LICENSE.md), for all code.

## Reporting a bug

`arizona_example` is not perfect software and will be buggy.
...
[GitHub issues: feature request](https://github.com/arizona-framework/arizona_example/issues/new?template=feature_request.md).
...
All fixes to `arizona_example` end up requiring a +1 from one or more of the project's maintainers.
...
`arizona_example` has been improved by
[many contributors](https://github.com/arizona-framework/arizona_example/graphs/contributors)!
